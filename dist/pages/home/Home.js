...
function Home() {
    return (React.createElement(Home_styles_1.HomeFlex, null,
        React.createElement(Home_styles_1.BannerContainer, { id: "container-test" },
            React.createElement("img", { src: "https://cdn.wallpapersafari.com/42/75/d8ptQ3.jpg", alt: "home-banner" }),
            React.createElement("p", null,
                "CHAMPS",
                React.createElement("span", null),
                "platform")),
        React.createElement(Home_styles_1.CurrentMatches, { id: "matches-box" },
            React.createElement(Home_styles_1.ButtonContainer, null,
                React.createElement(Home_styles_1.MatchLink, { key: 1 },
                    React.createElement(Home_styles_1.Button, null, "CURRENT MATCHES")),
                React.createElement(Home_styles_1.MatchLink, { key: 2 },
                    React.createElement(Home_styles_1.Button, { style: { display: "flex", justifySelf: "center" } }, "NEXT MATCHES")),
                React.createElement(Home_styles_1.MatchLink, { key: 3 },
                    React.createElement(Home_styles_1.Button, null, "RESULTS"))),
            teams_json_1.default.map((team, i) => {
                ...
                return (React.createElement(MatchCard_styles_1.CardSection, null,
                    React.createElement(MatchCard_1.MatchCard, { name: name, score: score, img: img, name2: name2, img2: img2, score2: score2 })));
            })),
        React.createElement(react_1.Swiper, { className: "swiper", spaceBetween: 10, slidesPerView: 4, loop: false, centerInsufficientSlides: false, centeredSlides: true, centeredSlidesBounds: true, autoplay: true, speed: 1000, pagination: true, modules: [swiper_1.Autoplay], style: {
            ...
            return (React.createElement(react_1.SwiperSlide, null,
                React.createElement(TeamCard_1.TeamCard, { teamName: name, teamImg: img, style: {
                        backgroundColor: "green",
                        color: "black",
                        // margin: "20px",
                    } })));
        })),
        React.createElement(Home_styles_1.PartnersDiv, null,
            React.createElement("h1", null, "OUR PARTNERS"),
            React.createElement("ul", null,
                React.createElement("li", { key: "p1" }, "PARTNER1"),
                React.createElement("li", { key: "p2" }, "PARTNER2"),
                React.createElement("li", { key: "p3" }, "PARTNER3")))));
}
